...
export default function Home() {
   ...
   return (
      <Box component={'main'} display={'flex'} flexDirection={{xs: 'column', md: 'row'}} alignItems={'center'}
         ...
         <Box>
            <br />
            <h1>Hi, I'm <span className={Style.focusInExpand} style={{background: info.gradient, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent'}}>{info.lastName}</span><span className={Style.hand}>🤚</span>
            </h1>
            <br />
